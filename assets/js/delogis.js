(function ($) {
  ...
  function thmSwiperInit() {
    ...
    if ($(".thm-swiper__slider").length) {
      $(".thm-swiper__slider").each(function () {
        ...
        var thmSwiperSlider = new Swiper(elm, options);
      });
    }
  ...
  function thmOwlInit() {
    ...
    if ($(".thm-owl__carousel").length) {
      $(".thm-owl__carousel").each(function () {
        var elm = $(this);
        var options = elm.data('owl-options');
        var thmOwlCarousel = elm.owlCarousel(options);
      });
    }
    ...
    if ($(".thm-owl__carousel--custom-nav").length) {
      $(".thm-owl__carousel--custom-nav").each(function () {
        var elm = $(this);
        var owlNavPrev = elm.data('owl-nav-prev');
        var owlNavNext = elm.data('owl-nav-next');
  ...
  if ($(".service-details__sidebar-service-list").length) {
    // dynamic current class
    var mainNavUL = $(".service-details__sidebar-service-list");
    dynamicCurrentMenuClass(mainNavUL);
  }
  ...
  if ($(".sticky-header__content").length) {
    ...
    var mobileNavContainer = document.querySelector(".sticky-header__content");
    mobileNavContainer.innerHTML = navContent;
  }
  ...
  if ($(".thm-accordion").length) {
    var accordionWrapper = $(".thm-accordion");
    accordionWrapper.each(function () {
      var $this = $(this);
      var accordionID = $this.attr("id");
      var accordionTitle = $this.find(".thm-accordion__title");
      $this.addClass(accordionID);
      // default hide
      var mainAccordionContent = $this.find(".thm-accordion__content").hide();
  ...
  function thmTinyInit() {
    // tiny slider
    var tinyElm = document.querySelectorAll(".thm-tiny__slider");
    tinyElm.forEach(function (tinyElm) {
      var tinyOptions = JSON.parse(tinyElm.dataset.tinyOptions);
      var thmTinySlider = tns(tinyOptions);
    });
  }
